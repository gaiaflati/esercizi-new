...
- La classe Persona deve avere i seguenti metodi:
    ...
    Se first_name e last_name sono due stringhe, assegnare 0 all'attributo relativo all'età di una persona; se first_name e last_name non sono due stringhe,
    ...
    Il valore viene modificato se e solo se viene passato al metodo un numero intero. In caso contrario, stampare un messaggio di errore, 
    ad esempio "L'età deve essere un numero intero!".
...
class Persona:
    ...
    def __init__(self, _first_name: str, _last_name: str) -> None:
        ...
        if type(_first_name) and type(_last_name)== str:
            self._age=0 

        elif type(_first_name) != str:
            self._first_name=None
            self._age=None
            return "Il nome inserito non è una stringa!"
        
        elif type(_last_name) != str:
    ...
    def getName(self):  #consente di ritornare il nome di una persona.
        return self._first_name
    
    def getLastname(self): #consente di ritornare il cognome di una persona.
        return self._last_name
    
    def getAge(self): #consente di ritornare l'età di una persona.
        return self._age
    
    def greet(self): #stampa il seguente saluto "Ciao, sono nome cognome! Ho età anni!"
